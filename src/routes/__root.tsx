...
import { ThemeProvider } from "../components/portfolio/useTheme";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Kaleab Moges" },
      {
        ...
        content:
          "Premium portfolio of Kaleab Moges: 6+ years teaching, 500+ students mentored, financial literacy and youth empowerment.",
      },
